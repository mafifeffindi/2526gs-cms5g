...
<body>
  <div class="wrap">
    <div class="top">
      <div>
        <h1 class="serif">Tambah Menu</h1>
        <div class="sub">Isi datanya rapi, biar kopinya makin berkelas.</div>
      </div>
      ...
      <form action="/menus" method="post">
        ...
        <div class="row">
          <div>
            ...
            <input name="category" value="Coffee" placeholder="Coffee / Non-Coffee / Snack" />
          </div>
          <div>
